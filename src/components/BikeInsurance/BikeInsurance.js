  ...
  return (
    <div>
      ...
      <div class="healthinsuranceSec">
        <div class="container">
          <div class="healthinsurance twowheelerinsusec">
            <div class="healthinsimg">
              <img
                src={"/assets/images/twowheelerimg.png"}
                alt="img"
                class="img-fluid"
              />
            </div>
            <div class="twowheelerinsu">
              <h2>
                Buy your two-wheeler insurance in <span>60 seconds!</span>
              </h2>
              <form>
      ...
      <div class="abouthealthins">
        <div class="healthinsimages">
          <img
            src={"/assets/images/bikeinsuimg01.png"}
            alt="img"
            class="img-fluid"
          />
        </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-7">
              ...
              <div class="healthinsimgsm">
                <img
                  src="img/twowheelerinsimg01.png"
                  alt="img"
                  class="img-fluid"
                />
              </div>
      ...
      <div class="abouthealthins boxrevers">
        <div class="healthinsimages">
          <img
            src={"/assets/images/benefitinsuranceimg01.png"}
            alt="img"
            class="img-fluid"
          />
        </div>
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-7">
              ...
              <div class="healthinsimgsm">
                <img
                  src="img/twowheelerinsimg02.png"
                  alt="img"
                  class="img-fluid"
                />
              </div>
