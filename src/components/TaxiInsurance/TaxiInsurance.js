...
const TaxiInsurance = () => {
  return (
    <div>
      ...
      <div class="healthinsuranceSec taxiinsurancesec">
        <div class="container">
          <div class="healthinsurance">
            <div class="texiiconsm">
              <img
                src={"/assets/images/taxiimgsm.png"}
                alt="img"
                class="img-fluid"
              />
            </div>
            ...
            <div class="healthinsimg texiimgbig">
              <img
                src={"/assets/images/taximainimg.png"}
                alt="img"
                class="img-fluid"
              />
            </div>
      ...
      {/* <!--Know More about Taxi Insurance  --> */}
      <div class="abouthealthins boxrevers abtTexiInsurance">
        <div class="healthinsimages">
          <img
            src={"/asstes/images/taxiinsuranceimg01.png"}
            alt="img"
            class="img-fluid"
          />
        </div>
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-7">
              <h2>
                Know More about <span>Taxi Insurance</span>
              </h2>
              <ul>
                <li>
              ...
              <div class="healthinsimgsm">
                <img
                  src={"/assets/images/texiinsusmimg01.png"}
                  alt="img"
                  class="img-fluid"
                />
              </div>
      ...
      <div class="abouthealthins abtTexiInsurance">
        <div class="healthinsimages">
          <img
            src={"/assets/images/taxiinsuranceimg02.png"}
            alt="img"
            class="img-fluid"
          />
        </div>
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-lg-7">
              <h2>
                Benefits of <span>Taxi Insurance</span>
              </h2>
              <ul>
                <li>
                  Contrary to popular belief, Lorem Ipsum is not simply random
              ...
              <div class="healthinsimgsm">
                <img
                  src={"/assets/images/texiinsusmimg02.png"}
                  alt="img"
                  class="img-fluid"
                />
              </div>
